...
import com.oltpbenchmark.benchmarks.lsd.tpcc.procedures.FutureTPCCProcedure;
...
public class TPCCWorker extends Worker<TPCCBenchmark> {
    ...
    protected TransactionStatus executeWork(Connection conn, TransactionType nextTransaction) throws UserAbortException, SQLException {
        try {
            FutureTPCCProcedure proc = (FutureTPCCProcedure) this.getProcedure(nextTransaction.getProcedureClass());
            proc.run((FutureConnection) conn , gen, terminalWarehouseID, numWarehouses,
