...
public class FutureCustomer {

    public Future<Integer> c_id;
    public Future<Integer> c_d_id;
    public Future<Integer> c_w_id;
    public Future<Integer> c_payment_cnt;
    public Future<Integer> c_delivery_cnt;
    public Future<Timestamp> c_since;
    public Future<Float> c_discount;
    public Future<Float> c_credit_lim;
    public Future<Float> c_balance;
    public Future<Float> c_ytd_payment;
    public Future<String> c_credit;
    public Future<String> c_last;
    public Future<String> c_first;
    public Future<String> c_street_1;
    public Future<String> c_street_2;
    public Future<String> c_city;
    public Future<String> c_state;
    public Future<String> c_zip;
    public Future<String> c_phone;
    public Future<String> c_middle;
    public Future<String> c_data;
